...
def index(request):
    """Displays the latest questions in the polls app."""
...
def vote(request, question_id):
    ...
    try:
        ...
        selected_choice.votes = F("votes") + 1  # Increment vote count safely
        selected_choice.save()
        # Redirect to results page to prevent duplicate form submission
